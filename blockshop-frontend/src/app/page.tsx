    ...
    <div className="flex h-screen bg-[#E5E5E5] px-6 relative">
      ...
      >
        ...
        >
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              <input
                ...
                className="w-full mt-1 px-4 py-3 border-2 rounded-lg bg-[#F0EFFF] border-[#6A55FF] text-[#6A55FF] placeholder-[#A7A3FF] font-poppins focus:outline-none"
          ...
          <button
            type="submit"
            className="w-full px-4 py-2 text-white bg-[#4D47C3] rounded-lg font-poppins hover:bg-[#3B38A6] focus:outline-none"
          >
            Login
          </button>
        </form>
